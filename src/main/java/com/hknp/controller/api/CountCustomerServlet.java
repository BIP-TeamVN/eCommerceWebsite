...
@WebServlet(urlPatterns = {"/api/count-customer-count"})
public class CountCustomerServlet extends HttpServlet {
   ...
   protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
      ...
      Long totalRows = CustomerDAO.getInstance().count(keyword);
