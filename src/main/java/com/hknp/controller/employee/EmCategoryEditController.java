...
@WebServlet(urlPatterns = {"/employee/product-category/edit"})
public class EmCategoryEditController extends HttpServlet {
   ...
   protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
      ...
      if (productCategoryId != 0) {
         ...
         if (productCategoryEdit != null) {
            ...
            ServletUtils.forward(req, resp, "/view/employee/em-product-category-edit.jsp");
            return;
         }
      }

      ServletUtils.forward(req, resp, "/employee/category");
   }
}