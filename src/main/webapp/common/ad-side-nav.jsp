   ...
   <div class="scrollbar-inner">
      ...
      <div class="navbar-inner">
         ...
         <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <ul class="navbar-nav">
               <li class="nav-item">
                  <a class="nav-link <%=isActive[0] ? "active" : ""%>" href="<%=isActive[0] ? "#" : "/admin"%>">
                     <i class="ni ni-tv-2 text-primary"></i>
                     <span class="nav-link-text">Dashboard</span>
                  </a>
               </li>
               <li class="nav-item">
                  <a class="nav-link <%=isActive[1] ? "active" : ""%>" href="<%=isActive[1] ? "#" : "/admin/employee"%>">
                     <i class="fa fa-user-circle text-success"></i>
                     <span class="nav-link-text">Nhân viên</span>
                  </a>
               </li>
               <li class="nav-item">
                  <a class="nav-link <%=isActive[2] ? "active" : ""%>" href="<%=isActive[2] ? "#" : "/admin/seller"%>">
                     <i class="fa fa-store text-darker"></i>
                     <span class="nav-link-text">Cửa hàng</span>
                  </a>
               </li>
               <li class="nav-item">
                  <a class="nav-link <%=isActive[3] ? "active" : ""%>" href="<%=isActive[3] ? "#" : "/admin/delivery"%>">
                     <i class="fa fa-user-ninja text-yellow"></i>
                     <span class="nav-link-text">Giao hàng</span>
                  </a>
               </li>
               <li class="nav-item">
                  <a class="nav-link <%=isActive[4] ? "active" : ""%>" href="<%=isActive[4] ? "#" : "/admin/customer"%>">
                     <i class="fa fa-users text-danger"></i>
                     <span class="nav-link-text">Khách hàng</span>
                  </a>
               </li>
               <li class="nav-item">
                  <a class="nav-link <%=isActive[5] ? "active" : ""%>" href="<%=isActive[5] ? "#" : "/admin/category"%>">
                     <i class="ni ni-bullet-list-67 text-default"></i>
                     <span class="nav-link-text">Ngành hàng</span>
                  </a>
               </li>
               <li class="nav-item">
                  <a class="nav-link <%=isActive[6] ? "active" : ""%>" href="<%=isActive[6] ? "#" : "/admin/product"%>">
                     <i class="fa fa-box text-default"></i>
                     <span class="nav-link-text">Sản phẩm</span>
                  </a>
               </li>
               <li class="nav-item">
                  <a class="nav-link <%=isActive[7] ? "active" : ""%>" href="<%=isActive[7] ? "#" : "/admin/brand"%>">
                     <i class="fa fa-copyright text-default"></i>
                     <span class="nav-link-text">Nhãn hiệu</span>
                  </a>
               </li>
               <li class="nav-item">
                  <a class="nav-link <%=isActive[8] ? "active" : ""%>" href="<%=isActive[8] ? "#" : "/admin/message"%>">
                     <i class="fa fa-comment-dots text-blue"></i>
                     <span class="nav-link-text">Tin nhắn</span>
                  </a>
               </li>
               <li class="nav-item">
                  <a class="nav-link <%=isActive[9] ? "active" : ""%>" href="<%=isActive[9] ? "#" : "/admin/feedback"%>">
