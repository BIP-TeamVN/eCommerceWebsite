         ...
         <div class="col">
            <div class="card">
               ...
               <div class="card-header border-0">
                  <h2 class="mb-0 text-center text-uppercase display-4">Chỉnh sửa thông tin cửa hàng</h2>
               </div>
               ...
               <form id="seller-edit-form" class="px-5">
                        ...
                        <div class="form-group">
                           ...
                           <div>
                              <input class="form-control" type="text" placeholder="VD: Nguyễn Văn" id="last-name"
                                     ...
                                     value="${sellerEdit.getUserEntity().getLastName()}">
                           </div>
                        ...
                        <div class="form-group">
                           ...
                           <div>
                              <input class="form-control" type="text" placeholder="VD: A" id="first-name"
                                     name="first-name" value="${sellerEdit.getUserEntity().getFirstName()}"
                                     maxlength=10>
                           </div>
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-6 form-group">
                        ...
                        <input class="form-control" type="date" min="<%=minDob%>"
                               value="${sellerEdit.getUserEntity().getDateOfBirthStr("yyyy-MM-dd")}" id="dob"
                               name="dob">
                     </div>
                  </div>
                        ...
                        <div class="form-group">
                           ...
                           <div>
                              <input class="form-control" type="tel" id="phone-number" name="phone-number"
                                     ...
                                     value="${sellerEdit.getUserEntity().getPhoneNumber()}">
                           </div>
                        ...
                        <div class="form-group">
                           ...
                           <div>
                              <input class="form-control" type="text" id="ssn" maxlength="12"
                                     ...
                                     value="${sellerEdit.getUserEntity().getSsn()}">
                           </div>
                  ...
                  <div class="form-group">
                     ...
                     <div>
                        <textarea class="form-control" id="address-street" name="address-street"
                                  ...
                                  rows="3">${sellerEdit.getUserEntity().getAddressEntities().get(0).getStreet()}</textarea>
                     </div>
                  ...
                  <div class="row">
                     <div class="col-md-6">
                        <!--SDT-->
                        <div class="form-group">
                           <label for="phone-number" class="form-control-label">Tên cửa hàng</label>
                           <div>
                              <input class="form-control" type="text" id="store-name" name="store-name" maxlength="20"
                                     value="${sellerEdit.getStoreName()}">
                           </div>
                           <small class="error-input text-danger">giấy phép kinh doanh không hợp lệ</small>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <!--CMND-->
                        <div class="form-group">
                           <label for="ssn" class="form-control-label">Link cửa hàng</label>
                           <div>
                              <input class="form-control" type="text" id="store-link" name="store-link" maxlength="20"
                                     value="${sellerEdit.getStoreLink()}">
                           </div>
                           <small class="error-input text-danger">Vui lòng nhập số tài khoản</small>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="row">
                     <div class="col-md-6">
                        <!--SDT-->
                        <div class="form-group">
                           <label for="phone-number" class="form-control-label">Giấy phép kinh doanh</label>
                           <div>
                     ...
                     <div class="col-md-6">
                        <!--CMND-->
                        <div class="form-group">
                           <label for="ssn" class="form-control-label">Số tài khoản</label>
                           <div>
