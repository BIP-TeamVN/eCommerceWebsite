...
<div class="main-content" id="panel">
            ...
            <div class="row align-items-center py-4">
               ...
               <div class="col-lg-6 col-5 text-right">
                  <button type="button" data-toggle="modal" data-target="#modal-add-product-category"
                          class="btn btn-secondary text-uppercase">Thêm ngành hàng
                  </button>
               </div>
            </div>
         </div>
   ...
   <%@ include file="../../common/form-add-product-category-em.jsp" %>
                              ...
                              <div class="col p-0">
                                 <div class="form-group m-1">
                                    ...
                                    <select class="form-control input-border" id="sort-by-column" onchange="search()">
                                       <option value="productCategoryId" selected>Mã</option>
                                       <option value="productCategoryName">Tên ngành hàng</option>
                                    </select>
                                 </div>
                              </div>
      ...
      success: function (data, textStatus, jqXHR) {
        ...
        $.each(list, function (index, item) {
          let html =
            ...
            '<a href="/employee/product-category/edit?id=' + item.id +'"class="btn btn-primary px-2 py-1" data-toggle="tooltip" data-placement="top" title="Chỉnh sửa thông tin">' +
