...
<div class="main-content" id="panel">
   ...
   <div class="container-fluid">
      ...
      <div class="row">
         <div class="col-md-10 ml-auto mr-auto">
            <h2 class="display-3 text-center text-uppercase my-5">Danh sách nhân viên giao hàng</h2>
         </div>
      </div>
      ...
      <div class="row">
         <div class="col ml-auto mr-auto text-right">
            <button type="button" data-toggle="modal" data-target="#modal-add-delivery"
                    class="text-uppercase btn btn-primary pl-4 pr-4 mb-4">Thêm nhân viên giao hàng
            </button>
         </div>
         <!-- From add delivery -->
         <%@ include file="../../common/form-add-delivery.jsp" %>
      </div>
         ...
         success: function (data, textStatus, jqXHR) {
            ...
            $.each(list, function (index, item) {
               let html =
                       ...
                       '<a href="/admin/delivery/edit?id=' + item.id +'" class="btn btn-primary px-2 py-1" data-toggle="tooltip" data-placement="top" title="Chỉnh sửa thông tin">' +
