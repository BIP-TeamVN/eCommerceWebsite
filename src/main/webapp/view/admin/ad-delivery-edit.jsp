...
<div class="main-content" id="panel">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-10 ml-auto mr-auto">
                <h2 class="display-3 text-center text-uppercase my-5">Chỉnh sửa thông tin nhân viên giao hàng</h2>
            </div>
        </div>
                ...
                <form id="delivery-edit-form">
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <input class="form-control" type="text" placeholder="VD: Nguyễn Văn" id="last-name"
                                           name="last-name" maxlength="40" value="${deliveryEdit.getUserEntity().getLastName()}">
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div>
                                    <input class="form-control" type="text" placeholder="VD: A" id="first-name" name="first-name" value="${deliveryEdit.getUserEntity().getFirstName()}" maxlength=10>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input class="form-control" type="date" min="<%=minDob%>" value="${deliveryEdit.getUserEntity().getDateOfBirthStr("yyyy-MM-dd")}" id="dob" name="dob">
                        </div>
                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <input class="form-control" type="tel" id="phone-number" name="phone-number" maxlength="10"
                                           placeholder="VD: 0987654321" value="${deliveryEdit.getUserEntity().getPhoneNumber()}">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <input class="form-control" type="text" id="ssn" maxlength="12"
                                           placeholder="VD: 123456789 hoặc 123456789012" value="${deliveryEdit.getUserEntity().getSsn()}">
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input class="form-control" type="date" min="2000-01-01" value="${deliveryEdit.getStartDateStr("yyyy-MM-dd")}" id="start-date"
                                   name="start-date">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <textarea class="form-control" id="address-street" name="address-street" placeholder="VD: Số 1 Đường ABC" rows="3">${deliveryEdit.getUserEntity().getAddressEntities().get(0).getStreet()}</textarea>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <img id="img-upload" class="mb-2 rounded avatar-img" src="${deliveryEdit.getUserEntity().getImageSrc()}"/>
        ...
        <div class="modal fade" id="successful-modal" tabindex="-1" role="dialog" aria-labelledby="conform-modal-lb" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        Cập nhật thông tin nhân viên giao hàng thành công !
                    </div>
                    <div class="modal-footer">
