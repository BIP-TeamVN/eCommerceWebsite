            ...
            <form id="user-edit-form">
               ...
               <div class="form-group">
                  ...
                  <div>
                     <input class="form-control" type="email" id="id" name="id" readonly
                            placeholder="VD: user@gmail.com" value="${userEdit.getUserId()}">
                  </div>
               </div>
               ...
               <div class="row">
                     ...
                     <div class="form-group">
                        ...
                        <div>
                           <input class="form-control" type="text" placeholder="VD: Nguyễn Văn" id="last-name"
                                  name="last-name" maxlength="40" value="${userEdit.getLastName()}">
                        </div>
                  ...
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <div>
                           <input class="form-control" type="text" placeholder="VD: A" id="first-name" name="first-name" value="${userEdit.getFirstName()}" maxlength=10>
                        </div>
               ...
               <div class="row">
                  ...
                  <div class="col-md-6 form-group">
                     ...
                     <input class="form-control" type="date" min="<%=minDob%>" value="${userEdit.getDateOfBirthStr("yyyy-MM-dd")}" id="dob" name="dob">
                  </div>
               </div>
                     ...
                     <div class="form-group">
                        ...
                        <div>
                           <input class="form-control" type="tel" id="phone-number" name="phone-number" maxlength="10"
                                  placeholder="VD: 0987654321" value="${userEdit.getPhoneNumber()}">
                        </div>
                     ...
                     <div class="form-group">
                        ...
                        <div>
                           <input class="form-control" type="text" id="ssn" maxlength="12"
                                  placeholder="VD: 123456789 hoặc 123456789012" value="${userEdit.getSsn()}">
                        </div>
               ...
               <div class="form-group">
                  ...
                  <div>
                     <input class="form-control" type="email" id="email" name="email" maxlength="40"
                            placeholder="VD: user@gmail.com" value="${userEdit.getEmail()}">
                  </div>
               ...
               <div class="form-group">
                  ...
                  <div>
                     <textarea class="form-control" id="address-street" name="address-street" placeholder="VD: Số 1 Đường ABC" rows="3">${userEdit.getAddressEntities().get(0).getStreet()}</textarea>
                  </div>
               ...
               <div class="form-group">
                  ...
                  <img id="img-upload" class="mb-2 rounded avatar-img" src="${userEdit.getImageSrc()}"/>
         ...
         <div class="modal-dialog" role="document">
            <div class="modal-content">
               ...
               <div class="modal-footer">
                  ...
                  <a href="/admin" class="btn btn-primary px-4">CÓ</a>
               </div>
            </div>
         </div>
      </div>
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      $.each(obj, function (key, value) {
        if (value.id === '${userEdit.getAddressEntities().get(0).getProvinceEntity().getProvinceId()}') {
  ...
  $('#province').change(function () {
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        console.log(obj);
        $.each(obj, function (key, value) {
          if (value.id === '${userEdit.getAddressEntities().get(0).getDistrictEntity().getDistrictId()}') {
  ...
  $('#district').change(function () {
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        console.log(obj);
        $.each(obj, function (key, value) {
          if (value.id === '${userEdit.getAddressEntities().get(0).getCommuneEntity().getCommuneId()}') {
...
<script src="../../assets/js/validate/validate-user-form.js"></script>
</body>
</html>
