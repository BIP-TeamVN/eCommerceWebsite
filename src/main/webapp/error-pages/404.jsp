...
<head>
   ...
   <title>eCommerce Website - Error 404</title>
   <style>
       ...
       input, button, textarea, select {
           font-family: 'Open Sans', sans-serif !important; font-size: 1.4rem; font-weight: 300; outline: none;
           border: 0; margin: 0; padding: 0; border-radius: 0; -webkit-appearance: none;
       }
       ...
       .button-effect:hover { padding-right: 5rem; }
       .button-effect i {
           position: absolute; top: 50%; right: 2rem;
           transition: 0.25s ease; opacity: 0; transform: translateY(-50%);
       }
       .button-effect:hover i { transform: translateY(-50%); opacity: 1; }
   </style>
...
<div class="container">
   <div class="row">
      ...
      <div class="col-md-6 align-self-center">
         <h1 class="text-danger">Lỗi 404</h1>
         <h2>Trang bạn tìm kiếm không tồn tại</h2>
         <p>
            URL có thể bị hỏng hoặc do quản trị viên xóa. <br>
            Nhấn vào nút bên dưới để quay lại!
         </p>
